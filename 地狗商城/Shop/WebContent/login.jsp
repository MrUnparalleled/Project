...
<script type="text/javascript">
	...
	function changeImg(obj){
		$(obj).attr("src","${pageContext.request.contextPath }/checkImg?time="+new Date().getTime());
	}
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/user?methodName=login" id="login_form">
						...
						<div style="color: red">${checkCodeInfo }</div>
						<div class="form-group">
