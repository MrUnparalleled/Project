			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						商城价: <strong style="color: #ef0101;">￥：${product.shop_price }元/份</strong> 参 考 价：
					...
					<div
						...
						<div>
							<a href="${pageContext.request.contextPath }/product?methodName=productList&cid=${cid}&currentPage=${currentPage}">返回商品列表</a>
						</div>
					</div>
				</div>
			</div>
