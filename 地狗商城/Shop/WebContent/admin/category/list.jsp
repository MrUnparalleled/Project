...
<script type="text/javascript">
			...
			function delCategory(obj){
				if(confirm("你是否要删除该商品类别？")){
					location.href="${pageContext.request.contextPath }/admin?methodName=delCategory&cid="+obj;
				}
			}
		</script>
</HEAD>
						...
						<c:forEach items="${categoryList }" var="category">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a href=""> <img
										...
										width="16" height="16" border="0" style="CURSOR: hand" onclick="delCategory('${category.cid}')">
								</a></td>
							</tr>
