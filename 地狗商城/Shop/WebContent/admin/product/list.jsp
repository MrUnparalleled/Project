...
<script type="text/javascript">
			...
			function delProduct(obj){
				if(confirm("是否删除该商品？")){
					location.href="${pageContext.request.contextPath}/admin?methodName=delProduct&pid="+obj;
				}
			}
		</script>
</HEAD>
<body>
	...
	<form id="Form1" name="Form1"
		...
		<input type="hidden" name="methodName" value="productList">
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${ pageContext.request.contextPath }/admin?methodName=productEditUI&pid=${product.pid }">
										<img
